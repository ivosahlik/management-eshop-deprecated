...
public class UserShipping {
	...
	private String userShippingVat;
	...
	public String getUserShippingVat() {
		return userShippingVat;
	}

	public void setUserShippingVat(String userShippingVat) {
		this.userShippingVat = userShippingVat;
	}
}
