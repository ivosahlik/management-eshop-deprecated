...
public class BillingAddress {
	...
	private String BillingAddressVat;
	...
	public String getBillingAddressVat() {
		return BillingAddressVat;
	}

	public void setBillingAddressVat(String billingAddressVat) {
		BillingAddressVat = billingAddressVat;
	}
